...
export default {
  ...
  // without it such a suite holds every landing until checksTimeoutMinutes; a check named in
  // requiredChecks or by branch protection must have PASSED on the landing head: one that was only
